...
- La possibilité pour le propriétaire de l’article ou du commentaire de supprimer leur
  participation
...
```
cd existing_repo
git remote add origin https://forge.univ-lyon1.fr/qualite-dev1/blogphp.git
git branch -M main
...
- [ ] [Set up project integrations](https://forge.univ-lyon1.fr/qualite-dev1/blogphp/-/settings/integrations)
